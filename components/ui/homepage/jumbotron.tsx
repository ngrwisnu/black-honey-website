...
const Jumbotron = () => {
  return (
    <section className="mt-20 flex min-h-[800px] w-full shrink items-center bg-[url('/images/default-image.webp')] bg-cover bg-center bg-no-repeat px-4 sm:shrink-0 sm:px-[140px]">
      <h1
        data-aos="fade-up"
